      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>
            Welcome to catellaTech environment!✨</h1>
          <h2 className={styles.title2}>ENS or Address: <span className={styles.color_ens}>{ens ? ens : address}</span></h2> 
          <div className={styles.description}>
            Its a founders wallet.
          </div>
          {renderButton()}
        </div>
        <div>
          <img className={styles.image} src="./01.svg" />
        </div>
      </div>
